...
public class QuantBacktestExperimentController {
    private final BacktestExperimentService service;
    public QuantBacktestExperimentController(BacktestExperimentService service){this.service=service;}
    @PostMapping public Result<BacktestExperimentDtos.CreateResponse> create(@RequestBody BacktestExperimentCreateRequest request){return Result.success(service.create(request));}
