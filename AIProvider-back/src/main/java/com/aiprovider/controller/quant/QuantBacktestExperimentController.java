...
public class QuantBacktestExperimentController {
    ...
    @PostMapping public Result<BacktestExperimentDtos.CreateResponse> create(@javax.validation.Valid @RequestBody BacktestExperimentCreateRequest request){return Result.success(creation.create(request));}
