...
public final class BacktestDtos {
    ...
    public record Strategy(String code,String name,String version,String description,int minimumRequiredBars,List<Parameter> parameters,List<String> supportedMarketTypes,List<String> supportedExecutionProfileCodes,List<String> supportedDirectionModes,List<String> requiredMarketFeatures) {}
    public record ExecutionProfile(String code,String name,String description,String marketType,String directionMode,String orderSizingMode,String entryOrderSide,String exitOrderSide,String positionSide,BigDecimal leverage,String fillModel,String transactionCostModel,String holdingCostModel,String fundingCostModel,String liquidationModel,String marginModel,List<String> requiredMarketFeatures,List<String> limitations) {}
    ...
    public record RunDetail(String runId,long datasetId,Instant datasetLastValidatedAt,String datasetLastSyncTaskId,String provider,String marketType,String dataType,String symbol,String intervalCode,Instant startOpenTimeInclusive,Instant endOpenTimeExclusive,String strategyCode,String strategyVersion,String executionProfileCode,String directionMode,String orderSizingMode,Map<String,Integer> requestedParameters,Map<String,Integer> resolvedParameters,BigDecimal orderAmount,BigDecimal feeRate,boolean forceCloseAtEnd,String status,BigDecimal progressPercent,String errorCode,String errorMessage,Instant queuedAt,Instant startedAt,Instant finishedAt,Integer barCount,Integer tradeCount,Integer winningTradeCount,Integer losingTradeCount,Integer breakEvenTradeCount,String executionModel,List<String> warnings,Metrics metrics,int equityPointCount) {
        public RunDetail(String runId,long datasetId,Instant datasetLastValidatedAt,String datasetLastSyncTaskId,String provider,String marketType,String dataType,String symbol,String intervalCode,Instant startOpenTimeInclusive,Instant endOpenTimeExclusive,String strategyCode,String strategyVersion,String executionProfileCode,String directionMode,String orderSizingMode,Map<String,Integer> requestedParameters,Map<String,Integer> resolvedParameters,BigDecimal orderAmount,BigDecimal feeRate,boolean forceCloseAtEnd,String status,BigDecimal progressPercent,String errorCode,String errorMessage,Instant queuedAt,Instant startedAt,Instant finishedAt,Integer barCount,Integer tradeCount,Integer winningTradeCount,Integer losingTradeCount,Integer breakEvenTradeCount,Map<String,Object> oldMetrics,int equityPointCount) {
            this(runId,datasetId,datasetLastValidatedAt,datasetLastSyncTaskId,provider,marketType,dataType,symbol,intervalCode,startOpenTimeInclusive,endOpenTimeExclusive,strategyCode,strategyVersion,executionProfileCode,directionMode,orderSizingMode,requestedParameters,resolvedParameters,orderAmount,feeRate,forceCloseAtEnd,status,progressPercent,errorCode,errorMessage,queuedAt,startedAt,finishedAt,barCount,tradeCount,winningTradeCount,losingTradeCount,breakEvenTradeCount,oldMetrics==null?null:String.valueOf(oldMetrics.get("_executionModel")),warnings(oldMetrics),toMetrics(oldMetrics),equityPointCount);
        }
