...
public interface ContentAiMapper {
    ...
    class GenerationRecord {
        private Long id; private Long contentItemId; private String generationType; private String modelName; private String inputJson; private String systemPromptSnapshot;
        public Long getId(){return id;} public void setId(Long v){id=v;} public Long getContentItemId(){return contentItemId;} public void setContentItemId(Long v){contentItemId=v;} public String getGenerationType(){return generationType;} public void setGenerationType(String v){generationType=v;}
