...
public class BacktestRunRow {
    ...
    public BigDecimal initialCapital, orderAmount, feeRate, progressPercent, winRate, grossProfit, grossLoss, netProfit, totalReturnRatio, maximumDrawdownRatio, profitFactor, averageTradeReturnRatio, buyAndHoldReturnRatio, totalFees, finalEquity, totalPnl, averageExposureRatio, maximumExposureRatio;
