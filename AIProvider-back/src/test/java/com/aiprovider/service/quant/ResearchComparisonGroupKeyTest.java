...
class ResearchComparisonGroupKeyTest {
  @Test void fixedVectorAndDecimalNormalizationAreStable() {
    ...
    assertEquals("b5ded73cadfb13268c88ff177d60a0482d05e4f6ed4951da35e78400950e7997", ResearchComparisonGroupKey.sha256(request));
  ...
  @Test void namesStrategiesAndParameterSpaceDoNotChangeGroupButContextDoes() {
    ...
    second = request();
    second.setInitialCapital(new BigDecimal("2000"));
    assertNotEquals(ResearchComparisonGroupKey.sha256(first), ResearchComparisonGroupKey.sha256(second));
  }
  ...
  private ResearchStudyCreateRequest request() {
    ...
    request.setTrainingBars(720); request.setValidationBars(240); request.setSelectionMetric("TRAIN_TOTAL_RETURN_RATIO"); request.setMinimumTrainTrades(5); request.setInitialCapital(new BigDecimal("1000")); request.setOrderAmount(new BigDecimal("0.01")); request.setFeeRate(new BigDecimal("0.0004")); request.setForceCloseAtEnd(true);
    return request;
  }
}
