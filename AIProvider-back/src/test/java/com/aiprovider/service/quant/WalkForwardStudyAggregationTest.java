...
class WalkForwardStudyAggregationTest {
  ...
  private BacktestExperimentDtos.ExperimentSummary experiment() {
    return new BacktestExperimentDtos.ExperimentSummary("e0", 1L, null, null, null, null, null, null, null, "USDM_PERPETUAL_LONG_ONLY_1X_V1", "LONG_ONLY", "BASE_QUANTITY", Map.of(), 0, Instant.EPOCH, Instant.EPOCH, Instant.EPOCH, Instant.EPOCH, new BigDecimal("1000"), BigDecimal.ONE, BigDecimal.ZERO, true, "RUNNING", new BigDecimal("40"), 0, 1, 0, 0, 0, 0, null, null, Instant.EPOCH, null, null, Instant.EPOCH);
  }
