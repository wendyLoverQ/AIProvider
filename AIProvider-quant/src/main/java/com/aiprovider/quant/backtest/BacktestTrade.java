...
public final class BacktestTrade {
    private final int tradeNo, entrySignalIndex, entryIndex, exitSignalIndex, exitIndex, barsHeld;
    ...
    public BacktestTrade(int no, int entrySignal, int entry, Instant entryTime, BigDecimal entryPrice, int exitSignal, int exitIndex, Instant exitTime, BigDecimal exitPrice, BigDecimal amount, BigDecimal gross, BigDecimal fee, BigDecimal net, BigDecimal ratio, int held, boolean forced, String reason) {
