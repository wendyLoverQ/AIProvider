...
public final class StrategyRegistry {
    ...
    public void register(QuantStrategyDefinition definition) {
        if (definition == null || definition.code() == null || definitions.putIfAbsent(definition.code(), definition) != null) throw new StrategyException("BACKTEST_STRATEGY_NOT_FOUND", "duplicate strategy code");
    }
